    ...
    return (
        <header className="h-128 w-full mb-10 relative flex justify-center items-center flex-col text-white">
            ...
            <div className="z-10 flex justify-center items-center flex-col gap-y-8 w-full px-3">
                <strong className="text-5xl md:text-7xl">FoodAuto</strong>
                <p className="text-3xl text-center md:text-4xl font-normal">Discover the best food & drinks All over the World</p>
                <SearchSection/>
            </div>
        </header>
    )
